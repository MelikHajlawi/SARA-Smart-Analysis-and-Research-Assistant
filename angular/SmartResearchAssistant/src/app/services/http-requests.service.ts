...
export class HttpRequestsService {
  private apiUrl = `http://${environment.apiHost}:8081/api/historical/process`;
  private exportUrl  = `http://${environment.apiHost}:8081/api/historical/export-data`;
  ...
  fetchThermalmap(params: ThermalmapParams): Observable<ThermalmapResponse | null> {
    const url = `http://${environment.apiHost}:8081/api/historical/thermalmap/reading_at_time`;
  ...
  fetchBleDevicesAtTime(params: BleDevicesAtTimeParams): Observable<BleDevicesAtTimeResponse | null> {
    const url = `http://${environment.apiHost}:8081/api/historical/radio/devices_at_time`;
  ...
  const url = `http://${environment.apiHost}:8081/datasets/customquery/${params.datasetId}`;
