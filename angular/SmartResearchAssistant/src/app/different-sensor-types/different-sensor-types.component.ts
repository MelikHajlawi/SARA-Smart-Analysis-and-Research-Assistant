...
public toastType: 'error' | 'info' = 'error';
  ...
  disableChartIcons: boolean = false;
...
onGranularityChange(granularity: string): void {
  ...
  saveExperiment(){}
    ...
    private updateDisableChartIcons(): void {
    this.disableChartIcons = this.charts.some(chart =>
      chart.droppedSensors.some(sensor =>
        sensor.sensorType === 'ble' || sensor.sensorType === 'thermalmap'
      )
    );
  }
}